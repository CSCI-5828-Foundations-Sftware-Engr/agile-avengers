...
class RequestPaymentFormValidation(unittest.TestCase):
    ...
    def test_request_payment_form_validation(self):
        # Load the login form
        ...
        # select "Request" option from dropdown
        payment_method_dropdown = Select(self.driver.find_element(By.ID, "paymentMethodType"))
        payment_method_dropdown.select_by_value("request")

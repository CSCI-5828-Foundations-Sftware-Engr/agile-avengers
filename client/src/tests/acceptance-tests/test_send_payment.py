...
class SendPaymentFormValidation(unittest.TestCase):
    ...
    def test_send_payment_form_validation(self):
        # Load the login form
        ...
        payment_method_input = self.driver.find_element(By.ID,"paymentMethod")
        payment_method_input.select_by_index(1)
